...
- `AutoUnlockIdleVehicles` -- Settings to automatically detect idle vehicles and unlock them. Vehicles near TCs are exempt.
  ...
  - `ExemptOwnedVehicles` -- While `true`, owned vehicles will be exempt from idleness checks.
